export const environment = {
    ...
    mocks: {
        ...
        museums: 'https://opendata.paris.fr/api/records/1.0/search/?dataset=liste-musees-de-france-a-paris&q=cp%3E%3D75001+AND+cp%3C%3D75020&rows=10000&facet=cp',
        cinemas: 'https://opendata.paris.fr/api/records/1.0/search/?dataset=cinemas-a-paris&rows=10000&facet=arrondissement'
    },
    typeList: ['Cinemas', 'Museums', 'Events'],
